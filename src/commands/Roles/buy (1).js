export default {
  ...
  async execute(message, args) {
    ...
    return message.channel.send(
      `Interested in purchasing Kryptic Client? It supports Fabric 1.21.11 and works on Windows & Linux with multiple launchers including Minecraft Launcher, Modrinth App, and Feather Client. Monthly and Lifetime plans are available, and we accept PayPal, LTC, and Donut SMP Money ( 700M )`
    );
  }
};
